...
const BannerManagement = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            >
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Ad Banner Management</h1>
                    <p className="text-gray-500">Manage promotional banners for user and scrapper apps</p>
                </div>
                <button
                ...
                {showAddForm && (
                    ...
                    >
                        <div className="bg-white p-6 rounded-2xl shadow-lg border border-green-100">
                            <h2 className="text-lg font-bold mb-4 text-gray-700">Create New Banner</h2>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative border-2 border-dashed border-gray-300 rounded-xl p-4 hover:bg-gray-50 transition-colors text-center cursor-pointer">
                                                ...
                                                <div className="flex flex-col items-center justify-center min-h-[100px]">
                                                    ...
                                                    <span className="text-xs text-gray-400 mt-1">Recommended size: 1200x400px</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                    ...
                    <div className="col-span-full text-center py-12 bg-white rounded-2xl shadow">
                        <p className="text-gray-500 text-lg">No banners found. Create one to get started!</p>
                    </div>
                ) : (
                    banners.map((banner) => (
                        <motion.div
                        ...
                        >
                            <div className="relative h-48 bg-gray-100 group">
                                ...
                                <div className="absolute top-2 right-2 bg-black bg-opacity-50 text-white text-xs px-2 py-1 rounded backdrop-blur-sm">
                                    {banner.targetAudience === 'both' ? 'All Users' : banner.targetAudience === 'user' ? 'Users Only' : 'Scrappers Only'}
                                </div>
                            </div>
