...
const ServiceDetailsPage = () => {
    ...
    const handleContinue = async () => {
        if (!description.trim()) {
            alert('Please describe what needs to be cleaned.');
            return;
        }
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-4 p-4 border-b bg-white/80 backdrop-blur-md sticky top-0 z-10">
                ...
                <h1 className="text-lg font-bold text-gray-800">Service Details</h1>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 pb-24">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm mb-6">
                    <label className="block text-gray-700 font-semibold mb-2">What needs cleaning?</label>
                    <textarea
                        value={description}
                        onChange={(e) => setDescription(e.target.value)}
                        placeholder="Describe the area, type of waste, and any specific requirements..."
                        rows={4}
                ...
                {/* Image Upload */}
                <div className="bg-white p-4 rounded-xl shadow-sm mb-6">
                    <label className="block text-gray-700 font-semibold mb-2">Add Photos (Optional)</label>
