  ...
  const profileOptions = [
    {
      ...
      title: getTranslatedText("My Profile"),
      desc: getTranslatedText("Edit name, phone, profile picture"),
      action: () => {
        navigate("/my-profile");
        if (onClose) onClose();
      },
    ...
    },
    {
      ...
      title: getTranslatedText("Wallet"),
      desc: getTranslatedText("Balance: ₹1,250 | Transactions"),
                ...
                <motion.div
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p
                      ...
                      style={{ color: "#718096" }}>
                      {getTranslatedText("Tap to change photo")}
                    </p>
                  </div>
        ...
        <motion.div
          ...
          <div
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                { label: getTranslatedText("Requests"), value: "24" },
                { label: getTranslatedText("Completed"), value: "18" },
                { label: getTranslatedText("Earnings"), value: "₹1,250" },
              ].map((stat, index) => (
