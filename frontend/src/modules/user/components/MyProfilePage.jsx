...
import { HiTrendingUp, HiCollection, HiCash } from "react-icons/hi";
import { MdCategory, MdPayment, MdCheckCircleOutline } from "react-icons/md";
            ...
            <motion.div
              ...
              <div
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                  {[
                    {
                      label: getTranslatedText("Total Requests"),
                    ...
                    {
                      label: getTranslatedText("Total Earnings"),
                      value: `₹${stats.totalEarnings}`,
                      icon: HiCash,
                      color: "#64946e",
                    },
                    {
                      label: getTranslatedText("Total Weight"),
                      value: `${stats.totalWeight} ${getTranslatedText("kg")}`,
                      icon: FaWeight,
                      color: "#64946e",
                    },
                    {
                      label: getTranslatedText("Avg Rating"),
                      value: `${stats.averageRating}`,
                      icon: FaStar,
                      color: "#64946e",
                    },
                    {
                      label: getTranslatedText("Top Category"),
                      value: getTranslatedText(stats.favoriteCategory),
                      icon: FaTrophy,
                      color: "#64946e",
                    },
                  ].map((stat, index) => {
