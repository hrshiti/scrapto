...
const SavedAddressesPage = () => {
  ...
  const addressTypes = [
    ...
    { value: 'other', label: 'Other', icon: FaMapPin },
  ];
  ...
  const handleSave = () => {
    if (!formData.label || !formData.address || !formData.city || !formData.state || !formData.pincode) {
                        ...
                        return (
                          ...
                          >
                            <IconComponent 
                              size={20} 
                              style={{ 
                                color: formData.type === type.value ? '#64946e' : '#718096' 
                              }} 
                            />
                            <span 
        ...
        <div className="space-y-3 md:space-y-4">
          {addresses.length === 0 && !isAddMode && !editingId ? (
            ...
            addresses.map((address, index) => {
              const TypeIcon = addressTypes.find(t => t.value === address.type)?.icon || FaMapPin;
              return (
                <motion.div
                  key={address.id}
                  initial={{ opacity: 0, y: 20 }}
                  ...
                  style={{ 
                    backgroundColor: '#ffffff',
                    border: address.isDefault ? '2px solid #64946e' : '1px solid rgba(100, 148, 110, 0.15)'
                  }}
                >
                      ...
                      <div className="flex items-center gap-2 mt-3">
                        {!address.isDefault && (
                          <button
                            ...
                            onMouseEnter={(e) => {
                              e.target.style.backgroundColor = 'rgba(100, 148, 110, 0.2)';
                            }}
                            onMouseLeave={(e) => {
                              e.target.style.backgroundColor = 'rgba(100, 148, 110, 0.1)';
                            }}
