        ...
        >
          <div className="flex flex-row items-center md:items-start gap-3 md:gap-6 lg:gap-8">
            ...
            <div className="flex-1 text-left">
              <h1 
                className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-2 md:mb-4 lg:mb-6 leading-tight text-right"
                style={{ color: '#2d3748' }}
              >
                Sell Your Scrap
                <br />
              ...
              <motion.div
                ...
                className="flex justify-end mb-4 md:mb-8 lg:mb-12"
              >
                <button
